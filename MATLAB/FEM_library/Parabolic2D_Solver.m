function [u, FE_SPACE, MESH, DATA, errorL2, errorH1] = Parabolic2D_Solver(elements, vertices, boundaries, fem, data_file, param)
...
fprintf('\n Assembling ... ');
t_assembly = tic;
[A, F , M]              =  Assembler_2D(MESH, DATA, FE_SPACE  );
