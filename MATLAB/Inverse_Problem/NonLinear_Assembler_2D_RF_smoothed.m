function [A, F, M] = NonLinear_Assembler_2D_RF_smoothed(MESH, DATA, FE_SPACE, OPERATOR, TC_d, TC_t, subdomain, t , w)
%NONLINEAR_ASSEMBLER_2D_smoothed Assembles the part in w in the stiffness matrix
