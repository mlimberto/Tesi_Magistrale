function [A, F, M] = NonLinear_Assembler_2D(MESH, DATA, FE_SPACE, OPERATOR, TC_d, TC_t, subdomain, t , w)
...
% Example call : A = Assembler_2D(MESH, DATA, FE_SPACE , 'diffusion' , [] , [] , FLAG_HEART_REGION, [] ,w )
